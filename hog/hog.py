...
def roll_dice(num_rolls, dice=six_sided):
    ...
    while roll_counter <= num_rolls:
        ...
        if num_this_roll == 1:
            pigout += 1
        sum_this_turn += num_this_roll   
        roll_counter += 1
    if pigout > 0:
        sum_this_turn = 1
    return sum_this_turn
    # END Question 1
...
def is_swap(score0, score1):
    ...
    score0 = score0 % 100
    score1 = score1 % 100
    first_digit_0 , second_digit_0 = score0 // 10 , score0 % 10
    first_digit_1 , second_digit_1 = score1 // 10 , score1 % 10
    if first_digit_0 == second_digit_1 and second_digit_0 == first_digit_1:
        return True
    else:
        return False
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=5):
    ...
    # BEGIN Question 9
    free_bacon = max((opponent_score % 10),(opponent_score // 10)) + 1
    if opponent_score > (score + free_bacon) and is_swap( score + free_bacon, opponent_score) :
        return 0
    elif opponent_score  < (score + free_bacon) and is_swap( score + free_bacon, opponent_score):
        return num_rolls
    else:
        return num_rolls
