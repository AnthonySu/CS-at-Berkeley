...
def find_centroid(cluster):
    ...
    for restaurant in cluster:
        a.append(restaurant_location(restaurant)[0])
        b.append(restaurant_location(restaurant)[1])
...
def k_means(restaurants, k, max_updates=100):
    ...
    while old_centroids != centroids and n < max_updates:
        ...
        # BEGIN Question 
        centroids=[]
        for cluster in group_by_centroid(restaurants,old_centroids):
...
def best_predictor(user, restaurants, feature_fns):
    ...
    for function in feature_fns:
        previous,r = find_predictor(user,reviewed,function)
        if highest <= r:
            highest, feature = r, previous
    return feature
    # END Question 8
